...
<tr><td colspan=2 align="center" bgcolor="#0000CC"><?php header_web();?></td></tr><tr>
    ...
    <?php
		...
		if($res){
		?>
        	<div class="info">Data Merk dengan ID <?php echo $id_merk?> telah diupdate.</div>
        <?php
		}
		else {
		?>
        	<div class="error"
            Data merk dengan ID <?php echo $id_merk?> gagal diupdate, dengan pesan kesalahan <b><?php echo mysqli_error($link)?></b></div>
        <?php
		}
	?>
    <p>&nbsp;</p></td>
