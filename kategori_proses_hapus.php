...
<tr><td colspan=2 align="center" bgcolor="#0000CC"><?php header_web();?></td></tr><tr>
    ...
    <?php
		...
		if($res){
		?>
        	<div class="info">Data kategori dengan ID <?php echo $id_kategori?> telah dihapus.</div>
        <?php
		}
		else {
		?>
        	<div class="error">
            Data kategori dengan ID <?php echo $id_kategori;?> gagal dihapus, dengan pesan kesalahan <b><?php echo mysqli_error($link)?></b>
            </div>
        <?php 
		}
	?>
